...
if __name__ == '__main__':
    ...
    filepath ="/storage/ZLL/code/mymodel/paper_model/multi/2/sulc/sulc_volume_16_std_U_SE_24.h5"
    #"/storage/ZLL/code/mymodel/paper_model/single/thickness_16_std_save_U_SE_24.h5"
    ...
    path_xls1='/storage/student22/net_hinge/xlsx/HCP/multi/sulc_volume_16_std_U_SE_24_100_l.xlsx'
    #'/storage/ZLL/code/mymodel/paper_model/single/xlsx/sulc_16_std_U_SE_24_20_l.xlsx'
    path_xls2='/storage/student22/net_hinge/xlsx/HCP/multi/sulc_volume_16_std_U_SE_24_100_r.xlsx'
    #####  data_load ####a
    ...
    test_l ='/storage/student22/3hinge_seg/HCP/new_data/sulc/lh/'
    test_r ='/storage/student22/3hinge_seg/HCP/new_data/sulc/rh/'

    test_1_l ='/storage/student22/3hinge_seg/HCP/new_data/volume/lh/'
    test_1_r ='/storage/student22/3hinge_seg/HCP/new_data/volume/rh/'
    ...
    predictionsA = model.predict([test_data,test_data_1])
