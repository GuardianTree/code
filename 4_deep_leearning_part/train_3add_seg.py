...
if __name__ == '__main__':
    ...
    filepath = "/storage/student22/net_hinge/mymodel/1/sulc_thickness_volume_16_std_U_SE_24_last.h5"#_ex
    filepath2 = "/storage/student22/net_hinge/mymodel/1/sulc_thickness_volume_16_std_save_U_SE_24_last.h5"#_e
