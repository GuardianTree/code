...
from  Network.Unet1_5add import unet
...
def data_generator(path1,path2,path3,path4,path5,label,number,batchsize):
    while(True):
         for i in range(number):
             ...
             DataE=load_mat(path5,i,batchsize)
             ...
             Y = Label[:, :,:]
             y = keras.utils.to_categorical(Y, num_classes=2)
             yield ({'input_1':X1,'input_2':X2,'input_3':X3,'input_4':X4,'input_5':X5},{'activation_42':y})


def var_data_generator(var_path1,var_path2,var_path3,var_path4,var_path5,var_label,var_number,var_batchsize):
    while(True):
         for i in range(var_number):
             ...
             var_DataE=load_mat(var_path5,i,var_batchsize)
             ...
             yield ({'input_1':var_X1,'input_2':var_X2,'input_3':var_X3,'input_4':var_X4,'input_5':var_X5},{'activation_42':var_y})
...
if __name__ == '__main__':
    ...
    #path_xls='/storage/student22/net_hinge/mymodel/xlsx/sulc_volume_16_std_U_SE_24.xlsx'
    #filepath = "/storage/student22/net_hinge/mymodel/5add_16_std_U_SE_24.h5"
    #filepath2 = "/storage/student22/net_hinge/mymodel/5add_16_std_save_U_SE_24.h5"#_e


    filepath = "/storage/ZLL/code/mymodel/5add_16_std_U_SE_24.h5"#_ex
    filepath2 = "/storage/ZLL/code/mymodel/5add_16_std_save_U_SE_24.h5"#_e
    ...
    train_2='/storage/student22/3hinge_seg/1000/new_data/16/seg/train/thickness/'#'/storage/ZLL/code/data/seg/train/curv/'
    ...
    train_5='/storage/student22/3hinge_seg/1000/new_data/16/seg/train/curv/'
    test_5='/storage/student22/3hinge_seg/1000/new_data/16/seg/test/curv/'
    ...
    epoch=50
    #####load_data####
    Data=data_generator(train_1,train_2,train_3,train_4,train_5,train_label,xlen,Batch_size)

    var_Data=var_data_generator(test_1,test_2,test_3,test_4,test_5,test_label,var_xlen,Batch_size)
    ...
    T5_shape = (size,size,vect)#(sample_size,16)
    model =unet(T1_shape,T2_shape,T3_shape,T4_shape,T5_shape) #concat_net(T1_shape,coor_shape) #unet(T1_shape)
    model.summary()
