...
if __name__ == '__main__':
    path_xls='/storage/student22/net_hinge/mymodel/xlsx/2add_16_std_U_t.xlsx'
    filepath = "/storage/student22/net_hinge/mymodel/2add_16_std_U_t.h5"
    filepath2 = "/storage/student22/net_hinge/mymodel/2add_16_std_save_U_t.h5"#_e
    ...
    train_2_l ='/storage/student22/3hinge_seg/1000/new_data/16/train/thickness/lh/'
    train_2_r ='/storage/student22/3hinge_seg/1000/new_data/16/train/thickness/rh/'
    ...
    Data=data_generator(train_1_l,train_1_r,train_2_l,train_2_r,label_l,label_r,xlen,sample_size,size)
    
    #print('Data.shape',Data.shape)
    var_Data=var_generator(test_1_l,test_1_r,test_2_l,test_2_r,label_test_l,label_test_r,
