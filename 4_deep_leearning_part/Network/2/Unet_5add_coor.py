...
def unet(T1_shape,T2_shape,T3_shape,T4_shape,T5_shape,X_shape,Y_shape,Z_shape):
    ...
    #x=Concatenate(axis=-1)([T1,coor_X,coor_Y,coor_Z])
    ...
    conv1_5 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(T5)
    ...
    con=Concatenate(axis=-1)([acti1, acti1_2, acti1_3, acti1_4, acti1_5,acti1_x,acti1_y,acti1_z])
    ...
    model = Model(inputs=[T1,T2,T3,T4,T5,coor_X,coor_Y,coor_Z], outputs=acti)
