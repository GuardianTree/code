...
def unet(T1_shape):
    ...
    # 288x288
    Conca_1 = Concatenate(axis=-1)([maxp1, T_1])
    conv3 = Conv2D(64, 3, padding='same', kernel_initializer='he_normal')(Conca_1)
    ...
    # 144x144
    Conca_2 = Concatenate(axis=-1)([maxp2, T_2])
    conv5 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(Conca_2)
    ...
    # 72x72
    Conca_3 = Concatenate(axis=-1)([maxp3, T_3])
    conv7 = Conv2D(256, 3, padding='same', kernel_initializer='he_normal')(Conca_3)
    ...
    # 36x36
    Conca_4 = Concatenate(axis=-1)([maxp4, T_4])
    conv9 = Conv2D(512, 3, padding='same', kernel_initializer='he_normal')(Conca_4)
    ...
    maxp5 = MaxPool2D(2)(acti10)

    Conca_5 = Concatenate(axis=-1)([maxp5, T_5])
    conv_11 = Conv2D(512, 3, padding='same', kernel_initializer='he_normal')(Conca_5)
