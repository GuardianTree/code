...
from  Network.Unet1_4add import unet
...
def data_generator(path1,path2,path3,path4,label,number,batchsize):
    while(True):
         for i in range(number):
             ...
             DataD=load_mat(path4,i,batchsize)
             ...
             Y = Label[:, :,:]
             y = keras.utils.to_categorical(Y, num_classes=2)
             yield ({'input_1':X1,'input_2':X2,'input_3':X3,'input_4':X4},{'activation_41':y})


def var_data_generator(var_path1,var_path2,var_path3,var_path4,var_label,var_number,var_batchsize):
    while(True):
         for i in range(var_number):
             ...
             var_DataD=load_mat(var_path4,i,var_batchsize)
             ...
             yield ({'input_1':var_X1,'input_2':var_X2,'input_3':var_X3,'input_4':var_X4},{'activation_41':var_y})
...
if __name__ == '__main__':
    ...
    #path_xls='/storage/student22/net_hinge/mymodel/xlsx/sulc_volume_16_std_U_SE_24.xlsx'
    filepath = "/storage/student22/net_hinge/mymodel/sulc_thickness_volume_area_16_std_U_SE_24_once.h5"
    #filepath2 = "/storage/student22/net_hinge/mymodel/sulc_thickness_volume_area_16_std_save_U_SE_24_new.h5"#_e


    #filepath = "/storage/ZLL/code/mymodel/thickness_sulc_16_std_U_SE_24.h5"#_ex
    #filepath2 = "/storage/ZLL/code/mymodel/thickness_sulc_16_std_save_U_SE_24.h5"#_e
    #path_xls='/storage/ZLL/code/mymodel/xlsx/2add_16_std_U_SE_24_t.xlsx'
    #####  data_load ####a
    #/storage/ZLL/code/data/new_data/train
    # T1
    ...
    train_2='/storage/student22/3hinge_seg/1000/new_data/16/seg/train/thickness/'
    test_2='/storage/student22/3hinge_seg/1000/new_data/16/seg/test/thickness/'

    train_3='/storage/student22/3hinge_seg/1000/new_data/16/seg/train/volume/'
    test_3='/storage/student22/3hinge_seg/1000/new_data/16/seg/test/volume/'
    
    train_4='/storage/student22/3hinge_seg/1000/new_data/16/seg/train/area/'
    test_4='/storage/student22/3hinge_seg/1000/new_data/16/seg/test/area/'
    ...
    """
    # T1
    train_1='/storage/ZLL/code/data/new_data/train/sulc/'
    test_1='/storage/ZLL/code/data/new_data/test/sulc/'

    train_2='/storage/ZLL/code/data/new_data/train/thickness/'
    test_2='/storage/ZLL/code/data/new_data/test/thickness/'

    train_3='/storage/ZLL/code/data/new_data/train/volume/'
    test_3='/storage/ZLL/code/data/new_data/test/volume/'
    
    train_4='/storage/ZLL/code/data/new_data/train/area/'
    test_4='/storage/ZLL/code/data/new_data/test/area/'
    ...
    epoch=50
    #####load_data####
    #Data=data_generator(train_1,train_2,train_3,train_4,train_label,xlen,Batch_size)

    var_Data=var_data_generator(test_1,test_2,test_3,test_4,test_label,var_xlen,Batch_size)
    ...
    T4_shape = (size,size,vect)#(sample_size,16)
    model =unet(T1_shape,T2_shape,T3_shape,T4_shape) #concat_net(T1_shape,coor_shape) #unet(T1_shape)
   ...
   ### evaluate ###
    #test
       #data
    predictionsA =model.predict_generator(var_Data)
    #model.predict([test_data_1,test_data_2,test_data_3,test_data_4])
