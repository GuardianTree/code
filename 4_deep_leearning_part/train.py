...
if __name__ == '__main__':
    #path_xls='/storage/student22/net_hinge/mymodel/xlsx/curv_16_std_U.xlsx'
    #filepath = "/storage/student22/net_hinge/mymodel/curv_16_std_U.h5"
    #filepath2 = "/storage/student22/net_hinge/mymodel/curv_16_std_save_U.h5"#_e
    
    filepath = "/storage/ZLL/code/mymodel/sulc_16_std_Unet.h5"#_ex
    filepath2 = "/storage/ZLL/code/mymodel/sulc_16_std_save_Unet.h5"#_e
    path_xls='/storage/ZLL/code/mymodel/xlsx/sulc_16_std_Unet.xlsx'
    #####  data_load ####a
    
    # T1
    
    test_l ='/storage/student22/3hinge_seg/1000/new_data/100_test/sulc/lh/'
    test_r ='/storage/student22/3hinge_seg/1000/new_data/100_test/sulc/rh/'
